...
const file_person_proto_rawDesc = "" +
	"\n" +
	"\fperson.proto\x12\bprotobuf\"B\n" +
	"\x06Person\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x05R\x02id\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\"7\n" +
	"\vAddressBook\x12(\n" +
	"\x06people\x18\x01 \x03(\v2\x10.protobuf.PersonR\x06peopleB\fZ\n" +
...
var file_person_proto_goTypes = []any{
	...
	(*AddressBook)(nil), // 1: protobuf.AddressBook
}
var file_person_proto_depIdxs = []int32{
	0, // 0: protobuf.AddressBook.people:type_name -> protobuf.Person
